...
describe "Authentication" do
  ...
  describe "authorization" do
    ...
    describe "for non-signed-in users" do
      ...
      describe "in the Microposts controller" do
        ...
        describe "after signing in" do
          ...
          end # it should render the desired protected page
        end # describe after signing in
      ...
      describe "in the Users controller" do
        ...
        describe "visiting the edit page" do
          ...
          it { should have_selector('title', text: 'Sign in') }
        end # describe visiting the edit page

        describe "submitting to the update action" do
          before { put user_path(user) }
          specify { response.should redirect_to(signin_path) }
        end # describe submitting to the update action
    ...
    describe "as wrong user" do
      ...
      end # describe visiting Users#edit page

      describe "submitting a PUT request to the Users#update action" do
        before { put user_path(wrong_user) }
        specify { response.should redirect_to(root_path) }
      end # describe submitting a PUT to the Users#update action
